        ...
        functionReady: function(instance, helper) {
            ...
            if ($loadIcon.length) {
                ...
                if (liveRunning && !livePaused) {
                    ...
                    actionItems.push(`<li><a onclick="event.preventDefault(); openTerminal('docker', ${escapeHtml(JSON.stringify(ct.info.Name))}, ${escapeHtml(JSON.stringify(ct.info.Shell))});"><i class="fa fa-terminal" aria-hidden="true"></i> ${$.i18n('console')}</a></li>`);
                }
                if (!liveRunning) {
                ...
                actionItems.push(`<li><a onclick="event.preventDefault(); openTerminal('docker', ${escapeHtml(JSON.stringify(ct.info.Name))}, '.log');"><i class="fa fa-navicon" aria-hidden="true"></i> ${$.i18n('logs')}</a></li>`);
                if (ct.info.template) actionItems.push(`<li><a onclick="event.preventDefault(); editContainer(${escapeHtml(JSON.stringify(ct.info.Name))}, ${escapeHtml(JSON.stringify(ct.info.template.path))});"><i class="fa fa-wrench" aria-hidden="true"></i> ${$.i18n('edit')}</a></li>`);
                actionItems.push(`<li><a onclick="event.preventDefault(); rmContainer(${escapeHtml(JSON.stringify(ct.info.Name))}, '${ct.shortImageId}', '${ct.shortId}');"><i class="fa fa-trash" aria-hidden="true"></i> ${$.i18n('remove')}</a></li>`);
                                ...
                                <ul class="fa-ul">
                                    ${(ct.info.State.Running && !ct.info.State.Paused) ?
                                        `${ct.info.State.WebUi ? `<li><a href="${escapeHtml(ct.info.State.WebUi)}" target="_blank"><i class="fa fa-globe" aria-hidden="true"></i> ${$.i18n('webui')}</a></li>` : ''}
                                         ...
                                         <li><a onclick="event.preventDefault(); openTerminal('docker', ${escapeHtml(JSON.stringify(ct.info.Name))}, ${escapeHtml(JSON.stringify(ct.info.Shell))});"><i class="fa fa-terminal" aria-hidden="true"></i> ${$.i18n('console')}</a></li>`
                                    : ''}
                                    ...
                                    <li><a onclick="event.preventDefault(); openTerminal('docker', ${escapeHtml(JSON.stringify(ct.info.Name))}, '.log');"><i class="fa fa-navicon" aria-hidden="true"></i> ${$.i18n('logs')}</a></li>
                                    ${ct.info.template ? `<li><a onclick="event.preventDefault(); editContainer(${escapeHtml(JSON.stringify(ct.info.Name))}, ${escapeHtml(JSON.stringify(ct.info.template.path))});"><i class="fa fa-wrench" aria-hidden="true"></i> ${$.i18n('edit')}</a></li>` : ''}
                                    <li><a onclick="event.preventDefault(); rmContainer(${escapeHtml(JSON.stringify(ct.info.Name))}, '${ct.shortImageId}', '${ct.shortId}');"><i class="fa fa-trash" aria-hidden="true"></i> ${$.i18n('remove')}</a></li>
                                </ul>
                            </div>
